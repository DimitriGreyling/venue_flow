...
class _$AuthSessionImpl extends _AuthSession {
  ...
  @override
  String toString() {
    return 'AuthSession(userId: $userId, email: $email, token: $token, refreshToken: $refreshToken, expiresAt: $expiresAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userId, email, token, refreshToken, expiresAt);
